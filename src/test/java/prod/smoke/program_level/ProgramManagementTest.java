...
public class ProgramManagementTest extends AbstractProgramLevelTest {
    ...
    public void prepareClientData() {
        client = getTestClientByCode("ProgramLevelTest client");
        clientName = client.getName();
        programName = "AutoGenerated program " + getFormattedDate("dd-MM-yy-H-mm");
        programName = getTestProgramByName(programName, client);
        patient = new Patient();
        patientName = "ProgramManagementTestPatient";
        patient.setFirstName("ProgramManagementTestPatient");
    ...
    public void addPatientManually_MHM_T114(){
        ...
        String actualPatientName = site.programSteps()
                .getPatientByName(clientName, programName, patientName);

        Assert.assertEquals(actualPatientName, patientName, "Actual patient differs from expected patient");
    }

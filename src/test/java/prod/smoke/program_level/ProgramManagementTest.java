...
public class ProgramManagementTest extends AbstractProgramLevelTest {
    ...
    public void createCaregiverProgramAndLinkToPatientProgram_MHM_T29(){
        //Test data
        String programName1 = "AutoGenerated program 1 " + getFormattedDate("dd-MM-yy-H-mm");
        String programName2 = "AutoGenerated program 2 " + getFormattedDate("dd-MM-yy-H-mm");

        site.programSteps()
                .addNewProgram(clientName, programName1, ProgramAccess.PUBLIC)
                .addNewProgram(clientName, programName2, ProgramAccess.PUBLIC);

        site.programSteps().linkedOneProgramToAnotherPatientProgram(programName1);

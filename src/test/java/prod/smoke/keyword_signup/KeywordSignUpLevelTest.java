...
public class KeywordSignUpLevelTest extends AbstractKeyWordSignUpLevelTest {
    ...
    public void movePatientToSpecificProgram() {
        ...
        site.programSteps().addNewProgram(client.getName(), landingProgram, ProgramAccess.PUBLIC);

        site.programSteps()
                .goToProgramSettings(client.getName(), programName)
                .addDestinationProgramQuestionKeywords("MOVE", landingProgram)
                .addAccountCreationQuestion(false,
                        "Destination Program",
        ...
        boolean isPatientMoved = site.programSteps()
                .goToProgramSettings(client.getName(), landingProgram)

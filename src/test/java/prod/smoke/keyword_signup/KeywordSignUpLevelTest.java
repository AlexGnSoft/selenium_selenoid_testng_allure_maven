...
public class KeywordSignUpLevelTest extends AbstractKeyWordSignUpLevelTest {
    ...
    private static final String FROM_PHONE_NUMBER_8 = "+15554622561";
    ...
    public void simulateConfirmation_MHM_T115() {
        //Test data
        String programName_T115 = "AutoGenerated program-T115";
        ...
        site.adminToolsSteps().initiateKeywordSignupSendAndAgree(clientName, programName_T115, FROM_PHONE_NUMBER_2, TO_ENDPOINT, SIGN_UP_KEYWORD_T115);
    ...
    public void addKeywordForSignUp_MHM_T38() {
        //Test data
        String programName_T38 = "AutoGenerated program-T38";
    ...
    public void addSignupQuestions_MHM_T39() {
        //Test data
        String programName_T39 = "AutoGenerated program-T39";
        ...
        site.adminToolsSteps().initiateKeywordSignupSendAgreeNameAndSkip(clientName, programName_T39, FROM_PHONE_NUMBER_3, TO_ENDPOINT, SIGN_UP_KEYWORD_T39);
    ...
    public void addCustomField_MHM_T40() {
        //Test data
        String programName_T40 = "AutoGenerated program-T40";
        ...
        site.adminToolsSteps()
                .initiateKeywordSignupSendAndAgreeTherapyStartDate(clientName, programName_T40, FROM_PHONE_NUMBER_4, TO_ENDPOINT, SIGN_UP_KEYWORD_T40);
    ...
    public void addValidationMessage_MHM_T56() {
        //Test data
        String programName_T56 = "AutoGenerated program-T56";
        ...
        //TODO: Simulate E2E Signup of a new patient
        site.adminToolsSteps()
                .initiateKeywordSignupSendAndAgree(clientName, programName_T56,FROM_PHONE_NUMBER_5,TO_ENDPOINT, SIGN_UP_KEYWORD_T56)
                .initiateSmsFirstLastNameDateSex(clientName, programName_T56, FROM_PHONE_NUMBER_5,TO_ENDPOINT, "F");

        site.adminToolsSteps().simulateSMSToClient(FROM_PHONE_NUMBER_5,TO_ENDPOINT, "No");
        site.programSteps().goToProgramSettings(clientName, programName_T56).getLastMessageFromLogsForNumber(FROM_PHONE_NUMBER_5);

        site.adminToolsSteps().initiateSmsFirstLastNameDateSex(clientName, programName_T56, FROM_PHONE_NUMBER_5,TO_ENDPOINT, "M");
    ...
    public void addCompletedMessage_MHM_T43() {
        //Test data
        String programName_T43 = "AutoGenerated program-T43";
        ...
        site.adminToolsSteps().initiateSignUpAgreeFirstLastNameDate(clientName, programName_T43, FROM_PHONE_NUMBER_6, TO_ENDPOINT, SIGN_UP_KEYWORD_T43);

        MessageLogItem signupResponse = site.programSteps()
                .goToProgramSettings(clientName, programName_T43)
                .getLastMessageFromLogsForNumber(FROM_PHONE_NUMBER_6);
    ...
    public void movePatientDuringKeywordSignup_MHM_T65() {
        ...
        String initProgram = "AutoGenerated newInit program-T65";
        String landingProgram = "AutoGenerated landing program-T65";
        ...
        site.adminToolsSteps().initiateKeywordSignupSendAndAgree(clientName, initProgram, FROM_PHONE_NUMBER_7, TO_ENDPOINT, SIGN_UP_KEYWORD_T65);
        //TODO: Simulate 'move' patient from newInitProgram to landingProgram
        site.adminToolsSteps().simulateSMSToClient(FROM_PHONE_NUMBER_7, TO_ENDPOINT, "MOVING");

        boolean isPatientMoved = site.programSteps()
                .goToProgramSettings(clientName, landingProgram)
                .isInProgram(landingProgram, FROM_PHONE_NUMBER_7);
    ...
    public void movePatientToSpecificProgram_MHM_T141() {
        ...
        String initProgram = "AutoGenerated newInit program-T141";
        String landingProgram = "AutoGenerated landing program-T141";
        ...
        site.programSteps()
                ...
                .addNewProgram(clientName, landingProgram, ProgramAccess.PUBLIC);
        //TODO: Simulate sms from patient to SignUp and AGREE to newInitProgram
        site.adminToolsSteps().initiateKeywordSignupSendAndAgree(clientName, initProgram, FROM_PHONE_NUMBER_8, TO_ENDPOINT, SIGN_UP_KEYWORD_141);

        site.programSteps()
                .goToProgramSettings(clientName, initProgram)
                .movePatientManually(clientName, landingProgram, FROM_PHONE_NUMBER_8);

        boolean isPatientMoved = site.programSteps()
                .goToProgramSettings(clientName, landingProgram)
                .isInProgram(landingProgram, FROM_PHONE_NUMBER_8);

...
public class KeywordSignUpLevelTest extends AbstractKeyWordSignUpLevelTest {
    ...
    @Test(description = "Move patient to a specific program based on the keyword answer")
    public void movePatientToSpecificProgram_MHM_T141() {
        //Test data
        String SIGN_UP_KEYWORD_T141 = getRandomString();
        ...
        site.programSteps()
                .addNewProgram(clientName, initProgram, ProgramAccess.PUBLIC).addKeywordForSignUp(SIGN_UP_KEYWORD_T141)
        ...
        site.adminToolsSteps().initiateKeywordSignupSendAndAgree(clientName, initProgram, FROM_PHONE_NUMBER_7, TO_ENDPOINT, SIGN_UP_KEYWORD_T141);

...
public class ClientManagementTest extends AbstractClientLevelTest {
    ...
    public void editClientsModules() {
        ...
        Assert.assertNotEquals(client, updatedClient, "Client list of modules was not updated");
        //External check-up on Message tab Level:
        Assert.assertTrue(site.messagesSteps().isMessageModulesEqualToClient(modulesToSet, updatedClient), "Available module types in module drop-down isn't same as in Client settings");
    }
    ...
    public void checkClientsModulesForMessages() {
        //I see no need to create a program
